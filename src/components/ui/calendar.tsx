...
function Calendar({
	...
	return (
		<DayPicker
			...
			classNames={{
				months:
					"flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0 w-72",
				month: "space-y-4",
				...
				button_previous:
					"cursor-pointer h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-1 text-yellow",
				button_next:
					"cursor-pointer h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-1",
